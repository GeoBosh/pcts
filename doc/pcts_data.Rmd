...
This vignette is part of package pcts, version `r pd[["Version"]]`.
...
accepts base R data objects, such as "ts", "mts", "numeric2, "matrix2, "data. frame", as well
...
example, the `AirPassengers` is a monthly time series starting in `{r} start(AirPassengers)`
